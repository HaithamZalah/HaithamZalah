...
- 📈 **[MISUO Sales & Delivery Dashboard](https://github.com/HaithamZalah/MISUO-Sales-Delivery-Performance-Dashboard)**: Interactive sales tracking dashboard focusing on platform performance, top products, and delivery metrics.
- 🚀 **[Hypermarket Sales Dashboard](https://github.com/HaithamZalah/Hypermarket-Sales-Dashboard)**: From Raw Transactions to Strategic Business Decisions: An End-to-End Retail Analytics Project in Power BI 
---
